...
def test_complete_survey_successful(client):
    ...
    create_answer(content="TestAnswer1", question_id=1)
    create_question(content="TestQuestion1", correct_answer_id=1, author_id=1)
    create_answer(content="TestAnswer2", question_id=2)
    create_question(content="TestQuestion2", correct_answer_id=2, author_id=1)
